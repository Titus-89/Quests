...
![alt text](Ressources/Screenshot_20251230_192121.png)

### La configuration de la zone indirecte du serveur

![alt text](Ressources/Screenshot_20251230_192537.png)

### Un ping depuis le client vers les 2 noms DNS du serveur

![alt text](Ressources/Screenshot_20251230_192755.png)

### le résultat de la commande nslookup depuis le client vers le serveur DNS

![alt text](Ressources/Screenshot_20251230_195021.png)
